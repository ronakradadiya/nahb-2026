    ...
    >
      ...
      <header
        ...
        style={{
          textAlign: "center",
          marginBottom: "40px",
          borderBottom: `3px solid ${colors.leed}`,
          paddingBottom: "25px",
          position: "relative",
        }}
      >
        <DownloadButton
          ...
          filename="header-sustainability"
        />
        <div
          style={{
            display: "inline-block",
        ...
        >
          Lilburn Residential Development | Green Building Standards
        </p>
        <div
          style={{
            display: "flex",
        ...
        >
          {[
            { label: "LEED Homes", icon: "🏠" },
            { label: "Energy Star", icon: "⭐" },
            { label: "WaterSense", icon: "💧" },
            { label: "SITES", icon: "🌿" },
          ].map((badge, idx) => (
            <span
              key={idx}
